...
function localContentPolicy(env = process.env, { includeDrafts = false } = {}) {
  ...
  return { audience: includeDrafts ? 'preview' : 'production', context: 'local', branch: 'local', netlify: false };
}
