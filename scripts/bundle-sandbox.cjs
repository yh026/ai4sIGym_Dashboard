...
const code=wrap('V2','lib/registry-v2.js')+wrap('V2Sheet','lib/registry-v2-sheet-adapter.js',"function require(name){if(name==='./registry-v2')return V2;throw new Error('Unknown module');}")+wrap('V3','lib/registry-v3.js')+fs.readFileSync(path.join(root,'google-apps-script/sandbox/Adapter.gs'),'utf8').replace('__IMPORT_CONFIG_ID__',importId);
new vm.Script(code);
